...
Block2::Block2(/*const Vector2D& pos*/)
{
    //location = pos;
    size = Vector2D(62.0, 62.0);
...
void Block2::Draw(const Vector2D&, bool) const
{
...
void Block2::OnHitCollision(GameObject* hit_object)
{
    // 衝突対象が Ball の場合
...
void Block2::Animation(float delta_seconds)
{
    if (death_flag == true)
    {
